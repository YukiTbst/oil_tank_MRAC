###########################################################################
## Makefile generated for component 'MRAC_for_coder_slower'. 
## 
## Makefile     : MRAC_for_coder_slower.mk
## Generated on : Wed Nov 23 15:05:39 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MRAC_for_coder_slower.elf
...
PRODUCT_NAME              = MRAC_for_coder_slower
MAKEFILE                  = MRAC_for_coder_slower.mk
MATLAB_ROOT               = D:/program files/matlab
MATLAB_BIN                = D:/program files/matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/oneDriveZJU317/OneDrive - zju.edu.cn/硕士课题/仿真/模型参考自适应控制/test
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/16219/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MRAC_for_coder_slower.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=3 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=MRAC_for_coder_slower -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MRAC_for_coder_slower.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/MRAC_for_coder_slower_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/MRAC_for_coder_slower_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MRAC_for_coder_slower_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/MRAC_for_coder_slower_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MRAC_for_coder_slower.o : $(START_DIR)/MRAC_for_coder_slower_ert_rtw/MRAC_for_coder_slower.c
	$(CC) $(CFLAGS) -o "$@" "$<"
