...
real_T MRAC_for_co__InitialCondition_a = 0.0;/* Referenced by: '<Root>/扰动观测器' */
real_T MRAC_for_co_k1_InitialCondition[2] = { 0.0, 0.0 } ;/* Referenced by: '<Root>/变量k1' */

real_T MRAC_for_co_k2_InitialCondition = 0.0;/* Referenced by: '<Root>/变量k2' */
real_T MRAC_for_code__InitialCondition[2] = { 0.0, 0.0 } ;/* Referenced by: '<Root>/参考模型' */
...
real_T MRAC_for_coder_slower__A[4] = { 0.0, -1.0, 1.0, -2.0 } ;/* Referenced by: '<Root>/参考模型' */

real_T MRAC_for_coder_slower__A_b = 0.0;/* Referenced by: '<Root>/扰动观测器' */
real_T MRAC_for_coder_slower__B[2] = { 0.0, 1.0 } ;/* Referenced by: '<Root>/参考模型' */

real_T MRAC_for_coder_slower__B_m = 1.0;/* Referenced by: '<Root>/扰动观测器' */
real_T MRAC_for_coder_slower__C[4] = { 1.0, 0.0, 0.0, 1.0 } ;/* Referenced by: '<Root>/参考模型' */

real_T MRAC_for_coder_slower__C_k = 1.0;/* Referenced by: '<Root>/扰动观测器' */
real_T MRAC_for_coder_slower_k1_A[4] = { 0.0, 0.0, 0.0, 0.0 } ;/* Referenced by: '<Root>/变量k1' */

real_T MRAC_for_coder_slower_k1_B[4] = { 1.0, 0.0, 0.0, 1.0 } ;/* Referenced by: '<Root>/变量k1' */

real_T MRAC_for_coder_slower_k1_C[4] = { 1.0, 0.0, 0.0, 1.0 } ;/* Referenced by: '<Root>/变量k1' */

real_T MRAC_for_coder_slower_k2_A = 0.0;/* Referenced by: '<Root>/变量k2' */
real_T MRAC_for_coder_slower_k2_B = 1.0;/* Referenced by: '<Root>/变量k2' */
real_T MRAC_for_coder_slower_k2_C = 1.0;/* Referenced by: '<Root>/变量k2' */
...
void MRAC_for_coder_slower_derivatives(void)
{
  ...
  /* Derivatives for StateSpace: '<Root>/参考模型' */
